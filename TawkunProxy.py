...
def proxyget(url): 
	try:
		...
		print("Terjadi kesalahan, melompat ke situs web berikutnya.\n") 
...
def proxylist(): 
	...
	print("IP saat ini di daftar proxy: %s" % (len(open("proxy.txt").readlines()))) 
	print ("\nProxylist Updated!\n")
...
def proxycheckerinit():
	...
	out_file.close()  
	print("\n\nIP saat ini di daftar proxy: %s\n" % (len(open("proxy.txt").readlines()))) 
...
def main(): 
	try:
		...
		print ("\nMengunduh dari daftar proxy gratis sedang berlangsung...")
		...
		print ("\nDownload dari blogspot sedang berlangsung...\n")
		...
		print ("\nMengunduh dari berbagai mirror sedang berlangsung...")
		...
		print ("\nMengunduh dari foxtools sedang berlangsung...")
		...
		print("\n")
		while True:
			choice = input("\nApakah Anda ingin memeriksa proxies? [Y/n] > ") 
			...
			if choice == 'N' or choice == 'n' or choice == 'no' or choice == 'No':
				...
				print ("Tolong tulis dengan benar.")
...
if __name__ == '__main__':
	...
	while True:
		choice = input("\nKamu yakin ingin mengunduh proxy? [Y/n] > ")
		if choice == 'Y' or choice == 'y' or choice == 'yes' or choice == 'Yes' or choice == '': 
			main()
			break
		if choice == 'N' or choice == 'n' or choice == 'no' or choice == 'No': 
